/**
 * @file mz700_bus_timing.h
 * @brief MZ-700: délky sběrnicových pulzů v GDG taktech.
 *
 * [neověřeno] Hodnoty PŘEVZATÉ z měření na reálném MZ-800 - pravdivé
 * budou jen u varianty s CPU deličkou 5 (PAL); u NTSC (delička 4) je
 * Michal musí změřit a pak se budou lišit (Michal 2026-07-29). Čtení
 * probíhá při náběžné hraně pulzu.
 *
 * Vyčleněno z mz700_gdg.h (mzhal krok 6) - jediný zdroj těchto hodnot,
...
#ifndef MZ700_BUS_TIMING_H
#define MZ700_BUS_TIMING_H
